  ...
  return (
    ...
    >
      ...
      <form onSubmit={handleSubmit} className='space-y-4'>
        ...
        className='my-1 block w-full bg-gray-700 border border-gray-600 rounded-md shadow-sm py-2 
        ...
        focus:outline-none focus:ring-offset-2 focus:ring-emerald-500 disabled:opacity-50'
        disabled={loading}
        >
          { loading ? (
            <>
              ...
              <>
                <PlusCircleIcon className='mr-2 pt-0.5 h-6 w-6' />
                Create Product
              </>
            )
          }
